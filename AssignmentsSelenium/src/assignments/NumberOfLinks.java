...
public class NumberOfLinks {
	...
	public void getLinkUrl(){
		String url = driver.findElement(By.linkText("Travel")).getAttribute("href");
	...
	public static void main(String[] args) {
		...
		NumberOfLinks numberOfLinks = new NumberOfLinks();
		numberOfLinks.invokeBrowser();
		numberOfLinks.getLinkCount();
		numberOfLinks.getLinkUrl();
		numberOfLinks.getAllLinkInfo();
}
